...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1"/>
        ...
        <title><?php echo $brand ?> Solusi Digital Untuk Kemajuan Bisnis UMKM </title>
    
    
        <meta name="description" content="<?php echo $brand ?> adalah platform yang membantu untuk membawa bisnis ke dunia digital dengan cara yang sederhana dan efektif.Dengan berbagai layanan, mulai dari pembuatan website hingga pemasaran digital, kami hadir untuk mendampingi setiap langkah Anda. Kami percaya bahwa setiap bisnis, besar maupun kecil, berhak merasakan manfaat dari kemajuan teknologi. Di GoOnline.id, kami mengutamakan solusi yang tepat, terjangkau, dan ramah untuk memastikan bisnis UMKM Anda bisa berkembang dengan maksimal di era digital.."/>
...
<link rel="icon" type="image/png" href="https://www.bata.com/on/demandware.static/Sites-bata-id-Site/-/default/dw867103ff/images/favicons/favicon-16x16.png" sizes="16x16" />
    ...
    <link rel="amphtml" href="https://majujaya.utopiajaya.com/slot-hl/online/?sosial=<?php echo $brand ?>">
...
<link rel="canonical" href="https://goonline.id/bangsa/?sosial=<?php echo $brand ?>"/>
...
<meta property="og:title" content="<?php echo $brand ?> Solusi Digital Untuk Kemajuan Bisnis UMKM " />

<meta property="og:description" content="<?php echo $brand ?> adalah platform yang membantu untuk membawa bisnis ke dunia digital dengan cara yang sederhana dan efektif.Dengan berbagai layanan, mulai dari pembuatan website hingga pemasaran digital, kami hadir untuk mendampingi setiap langkah Anda. Kami percaya bahwa setiap bisnis, besar maupun kecil, berhak merasakan manfaat dari kemajuan teknologi. Di GoOnline.id, kami mengutamakan solusi yang tepat, terjangkau, dan ramah untuk memastikan bisnis UMKM Anda bisa berkembang dengan maksimal di era digital." />

<meta property="og:url" content="https://goonline.id/bangsa/?sosial=<?php echo $brand ?>" />
...
// -->
    ...
    <div class="n-columns-2">
        <a href="https://majujaya.utopiajaya.com/slot-hl/online/<?php echo $brand ?>" rel="nofollow noreferrer" class="login">LOGIN</a>
        <a href="https://majujaya.utopiajaya.com/slot-hl/online/<?php echo $brand ?>" rel="nofollow noreferrer" class="register">DAFTAR</a>
        </div> 
    <div class="cc-pdp-carousels-container">
        ...
        <picture>
                ...
                <img src="https://i.pinimg.com/736x/bb/d5/a1/bbd5a1e03a0e9a98cc7ba18891fae118.jpg?" data-src="https://i.pinimg.com/736x/bb/d5/a1/bbd5a1e03a0e9a98cc7ba18891fae118.jpg" alt="<?php echo $brand ?> Solusi Digital Untuk Kemajuan Bisnis UMKM " title="<?php echo $brand ?> Solusi Digital Untuk Kemajuan Bisnis UMKM " class="b-lazyload"  width="817" height="817" loading="lazy" />
        </picture>
</div>
                    </div>
        ...
        <ul class="pdp-carousel-thumbnails cc-pdp-carousel-thumbnails">
                ...
                <li data-slide-to="0" class="cc-pdp-thumbnails-carousel-item">
                    <img src="https://i.pinimg.com/736x/bb/d5/a1/bbd5a1e03a0e9a98cc7ba18891fae118.jpg?" data-lazy="https://i.pinimg.com/736x/bb/d5/a1/bbd5a1e03a0e9a98cc7ba18891fae118.jpg?sw=140&amp;sh=140" alt="<?php echo $brand ?> Solusi Digital Untuk Kemajuan Bisnis UMKM " class="b-lazyload" width="140" height="140" />
                </li>
    ...
    <div id="zoom-target" class="cc-zoom-target" data-url-base-zoom='/on/demandware.store/Sites-bata-id-Site/en_ID/Product-ShowProductZoom?pid=' data-url-zoom='/on/demandware.store/Sites-bata-id-Site/en_ID/Product-ShowProductZoom?pid=540M_2022_5727404'></div>
        ...
        />
                ...
                <!-- Product Name -->
                <h1 class="product-name cc-pdp-product-name"><?php echo $brand ?> Solusi Digital Untuk Kemajuan Bisnis UMKM </h1>
        ...
        <!-- Select <Attribute> Label -->
            ...
            <div class="cc-size-label-container">
                <div class="size-selected cc-size-selected">
                    ...
                    <br><br><br><h4><div class="separator" style="clear: both; text-align: center;"><a href="https://majujaya.utopiajaya.com/slot-hl/online/<?php echo $brand ?>" imageanchor="1" style="margin-left: 1em; margin-right: 1em;"><img border="0" data-original-height="297" data-original-width="954" height="100" src="https://cdn.kdamp.website/img/168168.gif" width="320" /></a></div><br /><p><br /></p></h4>
                </div>
...
<div class="cc-social-wishlistbtn-container"> 
    ...
    <div class="copy-link-message d-none">
        <div class="alert alert-success text-center">
            The link to <?php echo $brand ?> Solusi Digital Untuk Kemajuan Bisnis UMKM  has been copied
        </div>
    </div>
</div>
                            ...
                            <div class="b-tabs_product-description">
                                ...
                                <div
                                    ...
                                    <span class="b-pdp__description" data-target="longDescription">
                                        <strong><?php echo $brand ?></strong> adalah platform yang membantu untuk membawa bisnis ke dunia digital dengan cara yang sederhana dan efektif.Dengan berbagai layanan, mulai dari pembuatan website hingga pemasaran digital, kami hadir untuk mendampingi setiap langkah Anda. Kami percaya bahwa setiap bisnis, besar maupun kecil, berhak merasakan manfaat dari kemajuan teknologi. Di GoOnline.id, kami mengutamakan solusi yang tepat, terjangkau, dan ramah untuk memastikan bisnis UMKM Anda bisa berkembang dengan maksimal di era digital..
                                    </span>
                                </div>
...
<div class="analytics-productPDP analytics-product"
    data-name="<?php echo $brand ?> Solusi Digital Untuk Kemajuan Bisnis UMKM "
    ...
    data-description="<?php echo $brand ?> adalah platform yang membantu untuk membawa bisnis ke dunia digital dengan cara yang sederhana dan efektif.Dengan berbagai layanan, mulai dari pembuatan website hingga pemasaran digital, kami hadir untuk mendampingi setiap langkah Anda. Kami percaya bahwa setiap bisnis, besar maupun kecil, berhak merasakan manfaat dari kemajuan teknologi. Di GoOnline.id, kami mengutamakan solusi yang tepat, terjangkau, dan ramah untuk memastikan bisnis UMKM Anda bisa berkembang dengan maksimal di era digital..."
    data-producturl="https://goonline.id/bangsa/?sosial=<?php echo $brand ?>"
